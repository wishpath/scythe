...
public class PlayerDTO {
  ...
  public boolean GREEN_ALBION_canMoveCharacterToControlledTerritory_rally = false; // allows character to move to any territory where you have a worker or Flag token
