...
public class Grid {
  ...
  static {
    ...
    grid[4][2] = new TileDTO(TileType.PLAINS_FOOD, 4, 2)
        .setRivers(DirectionType.SOUTH_WEST, DirectionType.SOUTH_EAST);
    grid[4][3] = new TileDTO(TileType.VILLAGE_WORKER, 4, 3)
    ...
    grid[4][6] = new TileDTO(TileType.MOUNTAIN_METAL, 4, 6)
        .setRivers(DirectionType.EAST);
    grid[4][7] = new TileDTO(TileType.TUNDRA_OIL, 4, 7)
        .setRivers(DirectionType.SOUTH_WEST, DirectionType.WEST, DirectionType.NORTH_WEST);
    grid[4][8] = new TileDTO(TileType.MOUNTAIN_METAL, 4, 8);

    grid[5][1] = new TileDTO(TileType.FORREST_WOOD,  5, 1)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST, DirectionType.SOUTH_EAST, DirectionType.SOUTH_WEST);
    grid[5][2] = new TileDTO(TileType.FORREST_WOOD,  5, 2)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST, DirectionType.SOUTH_EAST, DirectionType.SOUTH_WEST);
    grid[5][3] = new TileDTO(TileType.PLAINS_FOOD,  5, 3)
        .markAsTunnel()
        .setRivers(DirectionType.NORTH_WEST, DirectionType.SOUTH_WEST);
    grid[5][4] = new TileDTO(TileType.TUNDRA_OIL,  5, 4);
    grid[5][5] = new TileDTO(TileType.LAKE,  5, 5);
    grid[5][6] = new TileDTO(TileType.VILLAGE_WORKER,  5, 6)
        .markAsTunnel()
        .setRivers(DirectionType.NORTH_EAST);
    grid[5][7] = new TileDTO(TileType.LAKE,  5, 7);

    grid[6][1] = new TileDTO(TileType.MOUNTAIN_METAL,  6, 1)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST);
    grid[6][2] = new TileDTO(TileType.VILLAGE_WORKER,  6, 2)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST, DirectionType.EAST);
    grid[6][3] = new TileDTO(TileType.VILLAGE_WORKER,  6, 3)
        .setRivers(DirectionType.WEST, DirectionType.SOUTH_EAST);
    grid[6][4] = new TileDTO(TileType.TUNDRA_OIL,  6, 4)
        .markAsTunnel()
        .setRivers(DirectionType.SOUTH_EAST, DirectionType.SOUTH_WEST);
    grid[6][5] = new TileDTO(TileType.FORREST_WOOD,  6, 5)
        .setRivers(DirectionType.SOUTH_WEST);
    grid[6][6] = new TileDTO(TileType.MOUNTAIN_METAL,  6, 6);
    grid[6][7] = new TileDTO(TileType.TUNDRA_OIL,  6, 7);

    grid[7][0] = new TileDTO(TileType.HOME,  7, 0);
    grid[7][1] = new TileDTO(TileType.TUNDRA_OIL,  7, 1);
    grid[7][2] = new TileDTO(TileType.LAKE,  7, 2);
    grid[7][3] = new TileDTO(TileType.PLAINS_FOOD,  7, 3)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST);
    grid[7][4] = new TileDTO(TileType.MOUNTAIN_METAL,  7, 4)
        .setRivers(DirectionType.NORTH_WEST, DirectionType.NORTH_EAST, DirectionType.EAST);
    grid[7][5] = new TileDTO(TileType.VILLAGE_WORKER,  7, 5)
        .setRivers(DirectionType.WEST);
    grid[7][6] = new TileDTO(TileType.PLAINS_FOOD,  7, 6);
