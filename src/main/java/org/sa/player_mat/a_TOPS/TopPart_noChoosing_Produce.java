...
import org.sa.player_mat.a_TOPS.upgradable_state_change_top.UpgradableStateChange_Top_Produce_Decideable;
...
public class TopPart_noChoosing_Produce implements TopPart {
  ...
  private UpgradableStateChange_Top[] NO_CHOOSING_SIZE1ARRAY__PRODUCE = new UpgradableStateChange_Top[] {
      new UpgradableStateChange_Top_Produce_Decideable(2, 3)
  };
