...
public class TopPart_chooseBetweenTradeGoodsOrGainHearts implements TopPart {
  private TYPE__TopPart__TopPartChooseActionArray__ActionSpace TOP_PART_TYPE = TYPE__TopPart__TopPartChooseActionArray__ActionSpace.CHOOSE__TRADE__GAIN_HEARTS;
  private TopPartCost ONE_COIN = new TopPartCost_1Coin();
